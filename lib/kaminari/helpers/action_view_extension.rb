module Kaminari
  ...
  module ActionViewExtension
    ...
    def paginate(scope, options = {}, &block)
      paginator = Kaminari::Helpers::Paginator.new self, options.reverse_merge(:current_page => scope.current_page, :total_pages => scope.total_pages, :per_page => scope.limit_value, :param_name => Kaminari.config.param_name, :remote => false, :rel_next => "next", :rel_prev => "prev")
      paginator.to_s
    end
    ...
    def link_to_previous_page(scope, name, options = {}, &block)
      ...
      # link_to_unless scope.first_page?, name, params.merge(param_name => (scope.current_page - 1)) do
    ...
    def link_to_next_page(scope, name, options = {}, &block)
      params = options.delete(:params) || {}
      param_name = options.delete(:param_name) || Kaminari.config.param_name
      # link_to_unless scope.last_page?, name, params.merge(param_name => (scope.current_page + 1)) do
