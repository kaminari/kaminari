...
In case you have an older version of rails you can add the version number 

  gem 'kaminari', "~> VERSION NUMBER"
if your bundle install is not working than preferably install uning the latest version
...
Then bundle:
  ...
  gem install kaminari -v version number
