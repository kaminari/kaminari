...
* using a named route for the links

    <%= paginate @users, :route => :custom_users_path %>
  This will use the provided named route instead of url_for. Useful to avoid params getting converted to a query string.
