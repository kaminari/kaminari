...
* multiple themes
  ...
  Customize away! If no theme is specified, the one configured in Kaminari.config.default_theme will be used.

  Note: if the theme isn't present, kaminari will default back to the views included within the gem.
